	...
	<div>
		...
		<div class="row">
			<div class="col-xs-12 col-md-8 col-md-offset-2">
				...
				<div class="row">
					<div class="col-xs-12 control-group margin-top-10" v-bind:class="{'has-error':errors.name}">
				...
				<div class="row">
					<div class="col-xs-12 control-group margin-top-10" v-bind:class="{'has-error':errors.developer_site}">
				...
				<div class="row">
					<div class="col-xs-12 control-group margin-top-10" v-bind:class="{'has-error':errors.status}">
				...
				<div class="row">
					<div class="col-xs-12 control-group margin-top-10" v-bind:class="{'has-error':errors.platforms}">
