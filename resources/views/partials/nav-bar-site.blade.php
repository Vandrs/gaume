  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse navbar-right">
      <ul class="nav navbar-nav">
        <li><a href="{{url('/#home')}}">@lang('site.menu.home')</a></li>
        <li><a href="{{url('/#about')}}">@lang('site.menu.about')</a></li>
        <li><a href="{{url('/#we')}}">@lang('site.menu.we')</a></li>
        <li><a href="{{url('/#contact')}}">@lang('site.menu.contact')</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="{{route('site.teacher.contact')}}">@lang('site.menu.teacher')</a></li>
          </ul>
        </li>
