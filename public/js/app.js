...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uiv__ = __webpack_require__(44);
...
Vue.component('confirmation-start-modal', __webpack_require__(46));

window.app = new Vue({
    el: '#app',
    components: { Dropdown: __WEBPACK_IMPORTED_MODULE_0_uiv__["Dropdown"] },
    data: {
        menuToggled: false
    },
    methods: {
        ...
        showConfirmationClassModal: function showConfirmationClassModal() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		dismissCallback: function dismissCallback(event) {
...
Component.options.__file = "/var/www/gaume/resources/assets/js/components/lesson/ConfirmationStartModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ConfirmationStartModal.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4a3fa6ac", Component.options)
  } else {
    hotAPI.reload("data-v-4a3fa6ac", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4a3fa6ac", module.exports)
  }
}
