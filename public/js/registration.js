...
(function (root, factory) {
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(__webpack_require__(34));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_cityProvider__ = __webpack_require__(170);
...
var CityAutoComplete = {
	...
	setup: function setup(cityInput, destInput) {
		cityInput.typeahead({
			source: {},
			autoSelect: true
		});
	...
	updateSource: function updateSource(cityInput, data) {
		cityInput.data('typeahead').source = data;
	},

	bindChange: function bindChange(cityInput, destInput) {
